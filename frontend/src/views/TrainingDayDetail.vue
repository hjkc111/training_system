  ...
  <div class="training-detail-container">
    ...
    <div class="main-content">
      ...
      <div class="page-header">
        <el-page-header @back="goBack" :content="trainingDayInfo.training_day_name || '训练详情'"></el-page-header>
      ...
      <!-- 加载提示 -->
      <el-empty v-if="loading" description="加载网络布线训练日信息中..."></el-empty>
                  ...
                  <div class="image-compare-wrapper">
                    <div class="image-upload-group">
                      ...
                      <el-upload
                        ...
                        action="/api/network/image/upload"
...
const analyzeCurrentDocProject = async () => {
  ...
  analyzing.value = true
  try {
    const res = await axios.post('/api/network/training/project/analyze/doc', {
      training_day_id: trainingDayId,
      project_id: currentProject.project_id,
...
const analyzeCurrentImageProject = async () => {
  ...
  analyzing.value = true
  try {
    const res = await axios.post('/api/network/training/project/analyze/image', {
      training_day_id: trainingDayId,
      project_id: currentProject.project_id,
