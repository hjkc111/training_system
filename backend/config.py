...
# 网络布线项目 - 完整版（对标光电项目参数结构，含评分类型、标准图等）
PRESET_NETWORK_PROJECTS = [
    {
        "project_id": "network_1",
        "project_name": "RJ45水晶头端接",
        "project_desc": "网络布线标准水晶头端接操作，考核端接规范性、线序正确率、操作时长",
        "evaluation_type": "video_analysis"  # 视频分析（录制操作视频，AI分析规范性）
    },
    {
        "project_id": "network_2",
        "project_name": "110配线架端接",
        "project_desc": "110语音配线架端接操作，考核打线规范性、导通率、操作时长",
        "evaluation_type": "video_analysis"  # 视频分析（录制操作视频，AI分析规范性）
    },
    {
        "project_id": "network_3",
        "project_name": "光纤熔接操作",
        "project_desc": "光纤熔接标准流程，考核端面处理、熔接损耗、热缩管封装规范性",
        "evaluation_type": "video_analysis"  # 视频分析（录制操作视频，AI分析步骤合规性）
    },
    {
        "project_id": "network_4",
        "project_name": "链路通断测试",
        "project_desc": "网络链路通断、串扰、衰减测试操作，考核仪器使用规范性、结果判读正确率",
        "evaluation_type": "image_compare",  # 图片对比（上传测试结果图 vs 标准参考图）
        "standard_image_url": "http://localhost:8000/static/assets/network/standard_test_result.jpg"  # 链路测试标准图路径
    },
    {
        "project_id": "network_5",
        "project_name": "机柜理线与标签",
        "project_desc": "机柜内线缆整理、标签粘贴操作，考核理线美观度、标签规范性、扎带使用标准",
        "evaluation_type": "step_screenshot"  # 步骤截图（上传关键操作步骤截图）
    }
]
